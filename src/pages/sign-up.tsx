...
const SignUp = () => {
  ...
  const { error, status, check } = useSelector(
  ...
  const [getUpdateFromEmail, setGetUpdateFromEmail] = useState<boolean>(false);
  const [showSecondBoxSignup, setShowSecondBoxSignup] =
    useState<boolean>(false);
  ...
  return (
    ...
    >
      ...
      {showSecondBoxSignup ? (
        <SecondSignupBox setShowSecondBoxSignup={setShowSecondBoxSignup} />
      ) : (
        <div
          className="flex justify-center items-center w-full px-7 min-h-full
          py-12 relative z-30"
        >
          <div
          ...
          flex flex-col gap-y-5 bg-white/80 dark:bg-[#05070aaf] max-w-[525px] lg:max-w-[450px]"
            data-aos={innerWidth >= 1024 ? "fade-left" : "fade-right"}
          >
            <Link
              to={"/"}
              onClick={() => dispatch(ClearAllFields())}
            ...
            <form className="flex flex-col gap-y-5" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-y-4">
                <div className="flex flex-col gap-y-2">
                  ...
                  <input
                    ...
                    id="username-for-sign-up"
                    placeholder="Alireza_404"
                    value={field.userNameForSignUp}
                    maxLength={18}
                ...
                bg-gray-300/15 dark:bg-[#0b0e14] border outline-none transition-all duration-200
                  ${
                    ...
                    onChange={(event) => {
                      ...
                      dispatch(
                        UpdateStringField({ name: "userNameForSignUp", value })
                      );

                      const usernameRegex = /^[\w.-]{2,18}[a-zA-Z0-9]+$/;

                      if (usernameRegex.test(value)) {
                        dispatch(
                          UpdateBooleanField({
                            name: "isUserNameForSignUpTrue",
                            value: true,
                          })
                        );
                      } else {
                ...
                <div className="flex flex-col gap-y-2">
                  ...
                  <input
                    ...
                    className={`text-slate-800 dark:text-gray-200 font-medium text-sm px-2.5 py-2 rounded-md
                bg-gray-300/15 dark:bg-[#0b0e14] border outline-none
                 transition-all duration-200
                    ...
                    onChange={(event) => {
                      const value = event.target.value;
                      dispatch(
                        UpdateStringField({ name: "emailForSignUp", value })
                      );
                ...
                <div className="flex flex-col gap-y-2">
                  <label
                    htmlFor="confirm-password-for-sign-up"
                    className="text-sm lg:text-[15px] text-gray-500 dark:text-gray-400 font-semibold"
                  >
                    Confirm password
                  </label>
                  ...
                  <div className="relative">
                    <input
                      ...
                      autoComplete="new-password"
                      name="confirmPasswordForSignUp"
                      id="confirm-password-for-sign-up"
                      placeholder="........"
                      value={field.confirmPasswordForSignUp}
                      className={`text-slate-800 dark:text-gray-200 font-medium text-sm px-2.5 py-2 rounded-md
                    bg-gray-300/15 dark:bg-[#0b0e14] border outline-none transition-all duration-200
                      placeholder:text-2xl w-full 
                     ${
                    ...
                    dark:focus:border-gray-500/50`
                      ...
                      onChange={(event) => {
                        ...
                        if (
                          ...
                          dispatch(
                            UpdateBooleanField({
                              name: "isConfirmPasswordForSignUpTrue",
                              value: true,
                            })
                          );
                        } else {
              ...
              <div className="flex items-center gap-x-2.5 my-1">
                <div
                  ...
                  onClick={() => setGetUpdateFromEmail((prev) => !prev)}
                ></div>
