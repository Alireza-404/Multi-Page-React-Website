    ...
    >
      ...
      >
        <div
          ...
          flex flex-col gap-y-5 bg-white/80 dark:bg-[#05070aaf] max-w-[525px] lg:max-w-[450px] mt-14"
            ...
            <div className="flex flex-col gap-y-4">
              <div className="flex flex-col gap-y-2">
                ...
                <input
                  type="text"
                  autoComplete="name"
                  name="fullNameForSignUp"
                  id="full-name-for-sign-up"
                  placeholder="Alireza Shabani"
                  value={field.fullNameForSignUp}
                ...
                focus:border-gray-400/65 dark:focus:border-gray-500/50 transition-all duration-200"
                  onChange={(event) => {
                    ...
                    dispatch(
                      UpdateStringField({ name: "fullNameForSignUp", value })
                    );
                  }}
                />
              </div>
